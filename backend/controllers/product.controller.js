...
exports.getTarData = function(req, res, next) {
    if (JSON.stringify(req.body) == "{}") {
        ...
        Product.find({ [keys[0]]: params[keys[0]] }, function(err, data) {
            res.json(data);
        });
    }
};
...
exports.list = function(req, res, next) {
    ...
    Product.paginate(queryCondition, { page: page, limit: limit }, function(
        err,
        result
    ) {
...
// var namePut = req.params; //put方式(url示例: http://localhost:3000/product/test/zhaoqi500)
